...
func TestGetFunctionName(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/sysatom/framework/pkg/utils.foo1",
		},
		{
			name: "case2",
			args: args{
			...
			want: "github.com/sysatom/framework/pkg/utils.foo2",
		},
		{
			name: "case3",
			args: args{
			...
			want: "github.com/sysatom/framework/pkg/utils.foo3",
		},
	}
...
func TestParseFunctionName(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "case1",
			args: args{
				name: "github.com/sysatom/framework/pkg/utils.foo1",
			},
			want:  "github.com/sysatom/framework/pkg/utils",
			want1: "foo1",
		},
		{
			name: "case2",
			args: args{
				name: "dev.github.com/sysatom/framework/pkg/utils.foo2",
			},
			want:  "dev.github.com/sysatom/framework/pkg/utils",
			want1: "foo2",
		},
	}
	for _, tt := range tests {
