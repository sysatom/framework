...
//
//	-ldflags "-X github.com/sysatom/framework/version.Buildstamp=`date -u '+%Y-%m-%dT%H:%M:%SZ'`"
var Buildstamp = "undef"

// Buildtags set it to git tag:
//
//	-ldflags "-X github.com/sysatom/framework/version.Buildtags=`git describe --tags`"
var Buildtags = "v0.0.1"
